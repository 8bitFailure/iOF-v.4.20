function fancyScroll() {
  ...
  //   if(scrollvalue > (document.getElementById("").scrollTop)){
  ...
  //   if(scrollvalue > window.innerHeight * 10){
  //     document.getElementById("h3-1").style = "margin-left: 3vw;";
  //     document.getElementById("h3-2").style = "margin-left: 5vw;";
  //     for(let i = 7; i < 12; i++){
  //       document.getElementById(`box-intro-${i}`).style = "opacity: 1; margin-top: 5vw;";
  //     }
  //   }
